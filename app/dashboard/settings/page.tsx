...
const API_KEYS: KeyMeta[] = [
  ...
  { key: "CONTENT_MUSIC_DIR", label: "Music library (default ~/ContentOS/music)", phase: 2, critical: false, url: "drop CC0 tracks here" },
  { key: "PEXELS_API_KEY", label: "Pexels stock video + photos (b-roll)", phase: 2, critical: false, url: "pexels.com/api" },
